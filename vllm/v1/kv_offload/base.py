...
class OffloadingWorker(ABC):
    ...
    Workers receive pre-resolved DevicePointers (device memory addresses)
    and a medium-side LoadStoreSpec. The worker is a pure I/O engine —
    device pointer resolution happens at the OffloadingConnectorWorker
    boundary.
    """
